    ...
    function Calendar() {
      ...
      return _possibleConstructorReturn(
        ...
        ((_temp = _this = _possibleConstructorReturn(
          this,
          (_ref =
            Calendar.__proto__ || Object.getPrototypeOf(Calendar)).call.apply(
            _ref,
            [this].concat(args)
          )
        )),
        ...
        (_this.handleMonthChange = function(months) {
          ...
          _this.setState({
            ...
            displayDate: _dateUtils.defaultUtils.addMonths(
    ...
    _createClass(Calendar, [
      {
        ...
        value: function componentWillMount() {
          this.setState({
            displayDate: _dateUtils.defaultUtils.getFirstDayOfMonth(
      ...
      },
      {
        ...
        value: function getMinDate() {
          return (
            this.props.minDate ||
            _dateUtils.defaultUtils.addYears(new Date(), -100)
          );
        },
      },
      {
      ...
      },
      {
        ...
        value: function getToolbarInteractions() {
          return {
            prevMonth:
              _dateUtils.defaultUtils.monthDiff(
          ...
          return _react.default.createElement(
            ...
            _react.default.createElement(
              ...
              _react.default.createElement(
                ...
                _react.default.createElement(_WeekHeader.default, null),
